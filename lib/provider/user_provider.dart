...
import 'package:catatan/models/user.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';

class UserProvider extends ChangeNotifier {
  User _user = User(id: '', image: '', name: '', about: '');

  void updateUserImage(String imagePath) {
    _user.image = imagePath;
    notifyListeners();
  }
  ...
  void login(String id, String image, String name, String? about) async {
    ...
    final data =
        jsonEncode({'id': id, 'image': image, 'name': name, 'about': about});
  ...
  void logout() async {
    _user = User(id: '', image: '', name: '', about: '');
    notifyListeners();
    final prefs = await SharedPreferences.getInstance();
    prefs.clear();
  }
