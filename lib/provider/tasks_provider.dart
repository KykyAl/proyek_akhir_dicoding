import 'package:catatan/helper/db_helper.dart';
...
class TaskProvider extends ChangeNotifier {
  ...
  final Map<String, String> _taskGroup = {
    'rencana': 'assets/images/rencana.png',
  ...
  void addTask(String title, String? desc, DateTime? startingDate,
      String groupKey, DateTime date) {
    final newUserTask = UserTask(date.toString(), title, desc, startingDate,
        imagePath: _taskGroup[groupKey]!);
    _userTaskList.insert(0, newUserTask);
    calculatePercentage();
  ...
  void calculatePercentage() {
    int totalLenght = _userTaskList.length;
    ...
    int taskDone = totalLenght - cnt;
    double perc = (taskDone * 100) / totalLenght;
