import 'package:catatan/helper/db_helper_notes.dart';
import 'package:catatan/models/user_notes.dart';
...
class NotesProvider extends ChangeNotifier {
  ...
  void addNote(String title, String info, Color color) {
    UserNote newNote =
        UserNote(id: DateTime.now().toString(), title: title, info: info);
  ...
  Future<void> fetchData() async {
    ...
    _userList = dataList
        .map((e) => UserNote(
              ...
              title: e['title'],
              info: e['info'],
              noteColor: Color(int.parse(e['color'], radix: 16) + 0xFF000000),
            ))
        .toList();
    notifyListeners();
  }
