...
class _AddNoteState extends State<AddNote> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
          child: Column(
        children: [
          customTextField('Title', titleController, 50, 1),
          customHeight(context),
          customTextField('Information', infoController, 500, 10),
          customHeight(context),
          GridView.builder(
  ...
  Widget customTextField(String hintText,
      TextEditingController textEditingController, int maxLeng, int maxLine) {
    return Padding(
