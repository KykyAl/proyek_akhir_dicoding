...
class _EditNoteState extends State<EditNote> {
  ...
  List<Color> colorList = [
    ...
    const Color.fromARGB(255, 122, 213, 129),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            customField('Title', titleController, 50, 1),
            customHeight(context),
            customField('Information', infoController, 500, 10),
            customHeight(context),
            GridView.builder(
  ...
  Widget customField(String hintText, TextEditingController txController,
      int maxLeng, int maxLine) {
    return Padding(
  ...
  void _submit(BuildContext context) {
    ...
    Provider.of<NotesProvider>(context, listen: false)
        .updateNote(title, info, widget.index, noteColor);
    Navigator.of(context).pop();
  }
}
